...
namespace EcfDgii.Client.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260806141616_AddEcfStatusPollingColumns")]
    partial class AddEcfStatusPollingColumns
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("EcfDgii.Client.Domain.Entities.EcfDocument", b =>
                {
                    ...
                    b.Property<DateTime?>("SentToDgiiAt")
                        .HasColumnType("timestamp with time zone")
                    ...
                    b.HasIndex("State", "LastStatusCheckAt")
